...
const switchIcon = () => <Iconify icon="eva:chevron-down-fill" width={26} />;

const leftIcon = () => <Iconify icon="eva:arrow-ios-back-fill" width={26} />;

const rightIcon = () => <Iconify icon="eva:arrow-ios-forward-fill" width={26} />;

const calendarIcon = () => <Iconify icon="solar:calendar-mark-bold-duotone" width={26} />;

const clockIcon = () => <Iconify icon="solar:clock-circle-outline" width={26} />;
